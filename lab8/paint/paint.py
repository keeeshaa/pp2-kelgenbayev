...
# Drawing taskbar  
def taskBar():
    menu = pygame.image.load(r'C:\Users\Admin\Desktop\pp2\lab8\paint\menu.png')
    ...
    lineImage = pygame.image.load(r'C:\Users\Admin\Desktop\pp2\lab8\paint\drawline.png')
    lineImage = pygame.transform.scale(lineImage, (20, 20))
    screen.blit(lineImage, (150, 5))

    rectImage = pygame.image.load(r'C:\Users\Admin\Desktop\pp2\lab8\paint\rect.png')
    rectImage = pygame.transform.scale(rectImage, (30, 30))
    screen.blit(rectImage, (170, 0))

    squareImage = pygame.image.load(r'C:\Users\Admin\Desktop\pp2\lab8\paint\square.png')
    squareImage = pygame.transform.scale(squareImage, (30, 30))
    screen.blit(squareImage, (200, 0))

    circleImage = pygame.image.load(r'C:\Users\Admin\Desktop\pp2\lab8\paint\circle.png')
    circleImage = pygame.transform.scale(circleImage, (25, 25))
    screen.blit(circleImage, (230, 3))

    etrienImage = pygame.image.load(r'C:\Users\Admin\Desktop\pp2\lab8\paint\etrian.png')
    etrienImage = pygame.transform.scale(etrienImage, (30, 30))
    screen.blit(etrienImage, (255, 0))

    trienImage = pygame.image.load(r'C:\Users\Admin\Desktop\pp2\lab8\paint\trian.png')
    trienImage = pygame.transform.scale(trienImage, (30, 30))
    screen.blit(trienImage, (285, 0))

    rhombusImage = pygame.image.load(r'C:\Users\Admin\Desktop\pp2\lab8\paint\rhombus.png')
    rhombusImage = pygame.transform.scale(rhombusImage, (30, 30))
    screen.blit(rhombusImage, (315, 0))

    eraserImage = pygame.image.load(r'C:\Users\Admin\Desktop\pp2\lab8\paint\eraser.png')
